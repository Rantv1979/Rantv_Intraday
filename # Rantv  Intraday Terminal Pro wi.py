...
class MultiStrategyIntradayTrader:
    ...
    def get_open_positions_data(self):
        ...
        for symbol, pos in self.positions.items():
            ...
            try:
                ...
                historical_accuracy = data_manager.get_historical_accuracy(symbol, strategy) if strategy != "Manual" else 0.70
    ...
    def generate_strategy_signals(self, symbol, data):
        ...
        try:
            ...
            # BUY STRATEGIES - Only generate if historical accuracy > 70%
            ...
            if (ema8 > ema21 > ema50 and live > vwap and adx_val > 20 and htf_trend == 1):
                ...
                if rr >= 2.0:  # Minimum 1:2 risk-reward for intraday
                    ...
                    # Only generate signal if historical accuracy > 70%
...
with tabs[2]:
    ...
    if open_pos:
        ...
        for strategy in strategies_used:
            ...
            avg_historical = np.mean(historical_wins) if historical_wins else 0.70
